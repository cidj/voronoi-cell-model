function [] = Plotfig7(sp,XY,CePo,lengtha,lengthb,unitnm,x1,x2,y1,y2,num)
%PLOTFIG Summary of this function goes here
%Detailed explanation goes here
dotnm=length(XY);
XY=maintaindistance(XY,unitnm,0.01,lengtha,lengthb);
    ...
    if(l==ll)
        ...
        for j=1:l-1,
            ...
            if(bb&&squaresect( x1,x2,y1,y2,xx1,yy1,xx2,yy2 ))
                ...
                if(i0==j0)
                       plot([xx1,xx2],[yy1,yy2],'Color','g','Linewidth',2)
                else
                    plot([xx1,xx2],[yy1,yy2],'k','Linewidth',4)
                end
            end
        end
        ...
        if(l>2)
            ...
            if(bb&&squaresect( x1,x2,y1,y2,xx1,yy1,xx2,yy2 ))
                ...
                if(i0==j0)
                      plot([xx1,xx2],[yy1,yy2],'Color','g','Linewidth',4)
                else
