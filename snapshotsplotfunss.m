function [  ] = snapshotsplotfunss(fn,sp,cvxys,cellcenterposifile,an,bn,recN,lengtha,lengthb,tit,snapshotfile)
...
for i=0:N,
    ...
    vcxy=cell(cellnmd,1);
    for j=1:cellnmd,
        vcxy{j}=cvxys{pacetep,j};
    end
    Plotfig6ss(sp,vcxy,CCn,0,lengtha,0,lengthb,0,lengtha,0,lengthb,1);
    axis equal;
...
Plotfig6ss(sp,vcxy,CCn,0,lengtha,0,lengthb,0,lengtha,0,lengthb,0);
axis equal;
axis([0,lengtha,0,lengthb]);
