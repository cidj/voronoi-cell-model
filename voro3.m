...
[XY,va,vb,polyarea,polyedgelen,polyneibor ] = makeready_bd( cellnm,unitnm, XY,0.7,cellh,cellv, celllattx,celllatty);
...
for i=1:ncycl,
    ...
    %     XY2=XY;
    [ va_n,vb_n,polyarea_n,polyedgelen_n,polyneibor_n ] =  updatevoro_bd(XY, celllattx,celllatty,cellh,cellv );
